...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, storage=utils.storage.ImageStorage(), upload_to='images/%Y/%m', verbose_name='图片')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='heads/default.png', storage=utils.storage.ImageStorage(), upload_to='heads/%Y/%m', verbose_name='头像')),
