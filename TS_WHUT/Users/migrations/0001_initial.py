    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cates', models.CharField(blank=True, max_length=200, null=True, verbose_name='种类字符串')),
            ],
            options={
                'verbose_name': '图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('like', '点赞'), ('collection', '收藏')], default='like', max_length=10, verbose_name='点赞/收藏')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='收藏点赞时间')),
                ('image', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Users.ImageModel', verbose_name='图片')),
            ],
            options={
                'verbose_name': '点赞/收藏',
                'verbose_name_plural': '点赞/收藏',
            },
        ),
        migrations.CreateModel(
            name='UserProfile',
